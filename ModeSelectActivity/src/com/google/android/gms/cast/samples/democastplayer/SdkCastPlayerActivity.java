        ...
        mRepeatModeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position,
                ...
                if (mMediaPlayer != null
                        && mMediaPlayer.getMediaStatus().getQueueRepeatMode() != position) {
                    mMediaPlayer.queueSetRepeatMode(mApiClient, position, null).setResultCallback(
                            new MediaResultCallback(getString(R.string.mediaop_set_repeat_mode)));
                }
            }
